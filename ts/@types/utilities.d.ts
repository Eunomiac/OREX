...
declare const _default: {
    ...
    isInt: (ref: unknown) => ref is number;
    isFloat: (ref: unknown) => ref is number;
    ...
    isEmpty: (ref: anyList | anyArray) => boolean;
    hasItems: (ref: anyList | anyArray) => boolean;
    ...
    unique: {<Type>(array: Array<Type>): Array<Type>};

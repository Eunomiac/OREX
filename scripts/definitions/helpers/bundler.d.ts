export declare const U: {
    ...
    objMap: (obj: anyList | anyArray, keyFunc: false | keyMapFunc | valMapFunc, valFunc?: valMapFunc | undefined) => anyList | anyArray;
    ...
    objMerge: <Type_3 extends anyList | anyArray>(target: Type_3, source: DeepPartial<Type_3>, { isMutatingOk, isStrictlySafe }?: {
